      ...
      <div className="Home__container">
        <section className="Section1">
          ...
          >
            ...
            <p>
              Everyone experiences difficulty in different ways. Let IGPCM guide
              you in your path to achieving greatness .
            </p>
          </motion.div>
        </section>
            ...
            <section className="Section2">
              <div className="sub__Section2">
                <Grid container className="top__heading">
                  ...
                  <Grid item xs={12} sm={6}>
                    <p className="section__conetent">
                      We envisaged a world of tranquility and we are committed
                      to raising a generation of peace builders for sustainable
                      development.
                    </p>
                  </Grid>
                </Grid>
                ...
                <Grid container className="top__heading">
                  <Grid item xs={12} sm={6}>
                    <p className="section__conetent">
                      To achieve peace through the instrumentality of minds
                      shaping, inculcation of true values and development of
                      attitudes of tolerance and accommodation of divergence of
                      opinions and perceptions of people.
                    </p>
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <motion.h2
          ...
          <Container>
            ...
            <ul className="values__list" data-aos="flip-right">
              <li>
                ...
                viewpoints and opinions be tolerated no matter how provocative
                they seem.
              </li>

              <li>
                <b>AMICABILITY:</b> We know that settling people’s differences
                in a friendly, objective and committed manner ensues peace.
              </li>

              <li>
                <b>LEADERSHIP:</b> We demonstrates strategic, leading and
                superior decisions and arguments that influence people to agree
                with certain courses of action.
              </li>

              <li>
                <b>EQUALITY/EQUITY:</b> We believe that all people have certain
                desires and values and should be treated fairly and justly,
                irrespective of their social, cultural, political, religious and
                economic differences.
              </li>

              <li>
                <b>NEUTRALITY:</b> We take and maintain a posture of
                non-alignment while participating in conflict resolution.
              </li>

              <li>
                <b>TRANQUILITY:</b> We believe in peace, we pursue peace and we
                achieve peace for development to thrive.
              </li>
            </ul>
          </Container>
        </section>
        <section className="section3">
          <div className="cta2">
            ...
            <div item className="cta2__image">
