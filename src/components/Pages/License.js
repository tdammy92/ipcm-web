                    ...
                    <div className="License__wrapper">
                        ...
                        <div className="license__item">
                            ...
                            <div className="licence__question" data-aos="flip-down">
                                <p data-aos="fade-down">Are you a peace building and conflict management practitioner ?</p>

                                <p data-aos="fade-left">Are you interested in pursuing a consultancy career in
                                    peacebuilding and conflict resolution ?</p>

                                <p data-aos="fade-up">Are you running or intending to run a peacebuilding and
                                    conflict management NGO, CSO, CBO etc organization and needed a professional
                                    touch?</p>
                        ...
                        <div className="cta__Goodnews">
                            ...
                            <p>Earn a peace building and conflict management practitioner License as an
                                Individual or organization to boost your peace building career or consultancy
                                profile.
                            </p>
                        ...
                        <div className="benefit__container">
                            ...
                            <ul className="benefit">
                                <li>Get admitted at the level of Associate or Full Member if you are not already
                                    a member.</li>
                                <li>Get your company or organization admitted as corporate member at a
                                    discounted rate.</li>
                                ...
                                <li>Access to E-books and relevant materials to help your organization’s
